...
This web application allows users to quickly calculate their BMI based on their weight and height.

 ⚠️**NOTE** This project is still an **ongoing project**. It will be updated as soon as possible.
...
## 📋 How to Use
1. Open the `BMI calculator.html` file in any modern web browser.
...
Feel free to check the [issues page](https://github.com/O-Babasola/BMI-Calculator/issues) if you want to contribute.


## 👩‍💻 Author
- **O-Babasola** (frontendfuel) – [GitHub Profile](https://github.com/O-Babasola)
👤 **Oluwatise** [![alias](https://img.shields.io/badge/aka-frontendfuel-2ea44f?style=flat-square)](https://github.com/O-Babasola)
